          ...
          <form onSubmit={this.sendMessage}>
            ...
            <Row>
              <Col md={10} className="form-group">
                <input
                  type="text"
                  placeholder="e.g. Welcome to Emoji Chat :)"
                  className="form-control"
              ...
              <Col md={2}>
                <Dropdown className="form-group">
                  <Dropdown.Toggle block>Emoticons</Dropdown.Toggle>
                  <Dropdown.Menu className="scrollable-menu">
                    {_.map(this.emoticons, emoticon_pattern => {
                      return (
                        <Dropdown.Item
                          onClick={() => this.insertEmoticon(emoticon_pattern)}
                          key={emoticon_pattern}
                        >
                          {emoticon_pattern}
                        </Dropdown.Item>
                      );
